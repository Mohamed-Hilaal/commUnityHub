    ...
    return (
        ...
        <div className="px-3 py-3 lg:px-5 lg:pl-3">
            <div className="flex items-center justify-between">
                ...
                {location.pathname.includes("unityBoard") && currentUserDetails.current_unity_name && currentUserDetails.current_unity_name != "" && (
                    <div className="flex items-center justify-start rtl:justify-end">
                        <a className="flex ms-2 md:me-24">
                        <div className="w-5 h-5 mr-2 bg-gray-500 text-white rounded-full flex items-center justify-center font-semibold text-sm shadow-md">
                            {currentUserDetails.current_unity_name.charAt(0).toUpperCase()}
                        </div>
                            <span className="self-center font-semibold sm:text-sm whitespace-nowrap dark:text-white">{currentUserDetails.current_unity_name}</span>
                        </a>
                    </div>
                )}
